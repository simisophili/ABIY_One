...
namespace ABIY_One.Controllers
{
    public class ShoppingController : Controller
    {
        ...
        public string PaymentLink(string totalCost, string paymentSubjetc, int order_id)
        {
            ...
            stringBuilder.Append("&return_url=" + HttpUtility.HtmlEncode("https://abiytshirt2.azurewebsites.net/Shopping/Payment_Successfull?id=" + order_id));
            stringBuilder.Append("&cancel_url=" + HttpUtility.HtmlEncode("https://abiytshirt2.azurewebsites.net/Shopping/Payment_Cancelled?id=" + order_id));
